...
let RandomProducts= [
    {
     ...
     {
       "id": "17",
       "name": "CoCo Nourishing Cold Cream With Coffee and Vitamin E For Rich Moisturization - 200 g",
 ...
 append(RandomProducts)
 
 function append(data){
 
  var cartArr = JSON.parse(localStorage.getItem("cartDB")) || [];
 ...
 document.querySelector("#Sele").addEventListener("change",SortFun)
 
 function SortFun(){
     var selected = document.querySelector("#Sele").value;
      document.querySelector("#products").innerHTML='';
 
     if(selected === "low"){      
         var sorted = RandomProducts.sort(function(a,b){
